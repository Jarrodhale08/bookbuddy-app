# RevenueCat Setup for BookBuddy

## Quick Start

1. **Get your API Key**
   - Create account at [revenuecat.com](https://www.revenuecat.com)
   - Create a new project for BookBuddy
...
2. Create subscription products:
   - Monthly: `bookbuddy_monthly` - $2.99/month
   - Yearly: `bookbuddy_yearly` - $19.99/year
   - Lifetime: `bookbuddy_lifetime` - One-time
